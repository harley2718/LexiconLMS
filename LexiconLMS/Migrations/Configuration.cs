    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            context.Activity.AddOrUpdate(
                ...
                new Activity { ModuleId = 3, Type = Activity.ActivityType.Annat, Name = "Redovisning 2", StartDate = DateTime.Parse("2018-04-06"), StartTime = DateTime.Parse("2018-04-06 17:30:00"), EndTime = DateTime.Parse("2018-04-06 18:30:00"), Description = "Redovisning 2" });
